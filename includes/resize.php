...
if(!class_exists('growwwImage')) {
    ...
    class growwwImage
    {
        ...
        /**
         * For your custom default usage you may want to initialize an growwwImage object by yourself and then have own defaults
         */
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                error_log('growwwImage.process() error: ' . $ex->getMessage());
...
if(!function_exists('growwwImage')) {
    function growwwImage( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        /* WPML Fix */
        $growwwImage = growwwImage::getInstance();
        return $growwwImage->process( $url, $width, $height, $crop, $single, $upscale );
    }
}